...
const CreateNewEvent: React.FC<CreateNewEventProps> = ({
  ...
  return (
    ...
    <IonContent className="create_event">
      <Header  title="Giggles & Games Gala" showMenu={true} showPhonebook={false} />
      <div className="event_details">
        <div className="event_info">
          <figure>
            <img src={EventDp} alt="Event" />
          </figure>
          <p>Lorem ipsum dolor sit amet consectetur. Feugiat tristique adipiscing augue vestibulum comma. Nec facilisi accumsan at pretium tempor et magna.</p>
          <ul className="listitems">
            <li>
              <div className="venue_info">
                <span className="dp">
                  <img src={clockIcon} alt="Page Back" />
                </span>
        ...
        <div className="users_info">
            <div className="users_head">
              <h6>Invite Guests</h6>
              <a><img src={addUserIcon} alt="Event" /></a>
            </div>
            <div className="users_list">
              <ul>
                <li>
                  <span>
                    <img src={userDp} alt="Event" />
                    <em></em>
                  </span>
        ...
        <div className="status_sec">
          ...
          <div className="status_cards success">
            <div className="status_card">
                <small><img src={userCrossIcon} alt="Event" /></small>
                <label>Attending</label>
                <span className="devider"></span>
                <em>0</em>
            </div>
            <div className="status_card error">
                <small><img src={userTickIcon} alt="Event" /></small>
                <label>Not Attending</label>
                <span className="devider"></span>
                <em>0</em>
            </div>
            <div className="status_card warning">
                <small><img src={helpIcon} alt="Event" /></small>
