...
import AddMemberPresenter from "./AddMemberPresenter"; // Adjust the import path based on your project structure
import {
  LocationInfo,
  AddMemberProps,
  DraftEvent,
...
export default {
  title: "GoFlock/Presenters/AddMember",
  component: AddMemberPresenter,
};

const Template: StoryFn<AddMemberProps> = (args) => (
  <AddMemberPresenter {...args} />
);
